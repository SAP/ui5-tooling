...
By leaving dependency management up to the tool of your choice (see [FAQ: Why package.json? / Why npm?](/ui5-tooling/pages/FAQ/#why-packagejson-why-npm)) you have a variety of options.  
