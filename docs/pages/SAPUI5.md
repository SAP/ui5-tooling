...
SAPUI5 libraries are hosted on the public npm registry at `registry.npmjs.org`. However, you should not install them using node package managers e.g. npm. Instead, please let the UI5 Tooling handle them by following this guide.
