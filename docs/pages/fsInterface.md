The [fsInterface](https://sap.github.io/ui5-tooling/v3/api/module-@ui5_fs_fsInterface.html) module is a custom fs implementation which is used to replace node [fs](https://nodejs.org/api/fs.html).
