...
- `ModuleBundleOptions.debugMode` has been removed
- `ModuleBundleOptions.sourceMap` has been added, defaulting to `true`
- `ModuleBundleOptions.optimize` **[BREAKING]** now always defaults to `true` [#685](https://github.com/SAP/ui5-builder/pull/685)
